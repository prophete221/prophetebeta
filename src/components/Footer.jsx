          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs">
                ...
                <li><a href="/blog" className="text-gray-500 hover:text-emerald transition-colors">Tous les articles →</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs">
                {LEGAL.links.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-gray-500 hover:text-emerald transition-colors">{link.label}</a>
                  </li>
                ))}
              </ul>
              {/* WhatsApp */}
