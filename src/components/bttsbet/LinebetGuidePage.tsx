...
const content: Record<GuideVariant, { kicker: string; title: ReactNode; intro: string; sections: { title: string; text: string }[] }> = {
  promo: {
    ...
    title: <>Code promo Linebet Afrique <span className="linebet-gradient-text">VISION221</span></>,
    intro: 'Le guide central pour comprendre le code partenaire VISION221, suivre le parcours d’inscription et vérifier les conditions avant d’utiliser Linebet.',
    sections: [
